...
class _EventSignupScreenState extends State<EventSignupScreen> {
  ...
  bool canSignUp(TeamMemberDto teamMemberDto){
    return teamMemberDto.participationStatus != ParticipationStatus.REGISTERED || teamMemberDto.selected;
  }
                                    ...
                                    switch (snapshot2.connectionState) {
                                      ...
                                      default:
                                        if (snapshot.hasError) {
                                          ...
                                          return snapshot2.data!.isEmpty ? const Center(child: Text("There is nobody to sign up!"),):
                                          Column(
                                            children: [
                                              ...
                                              !_canSignUp && snapshot2.data != null
                                                  ? Text(
                                                t.events.alreadySignedUp,
                                                style: Constants
                                                    .errorSmallTextStyle
                                                    .copyWith(
                                                    color: Colors.red),
                                                ...
                                                child: ListView.builder(
                                                  ...
                                                  itemBuilder: (BuildContext context, int index) {
                                                    ...
                                                    return CheckboxListTile(
                                                      ...
                                                      enabled: !snapshot.data!.eventEnded! && teamMemberSnapshot[index].participationStatus != ParticipationStatus.REGISTERED && _canSignUp,
                                                      value: _selectedItemIndex == index || teamMemberSnapshot[index].participationStatus == ParticipationStatus.REGISTERED,
                                                      ...
                                                      title: Text("${teamMember.name} ${teamMember.lastName}" ?? " ",
